...
public class file_encrption extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        file_enc.setText("Upload And Encrypt File");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(file_enc, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                            .addComponent(key))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(59, 59, 59)
                .addComponent(file_enc, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void file_encActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_file_encActionPerformed
        ...
        try {
            if (res == JFileChooser.APPROVE_OPTION) {//if file chosen and approve enter the if
                ...
                File encryptedFile = new File("Path"+appendDate(fileName.split("\\.")[0])+"."+fileName.split("\\.")[1]);
                FileOutputStream outputStream = new FileOutputStream(encryptedFile);
                byte[] data = new byte[1024], tmp;
                int keylen = 32, ivlen = 16, cnt;
                SecureRandom random = new SecureRandom();//create cryptographically strong random number 
                byte salt[] = new byte[8];
                random.nextBytes(salt);//take 8 bytes
                InputStream is = new FileInputStream(inputFile);
                byte[] keyandIV = SecretKeyFactory.getInstance("PBKDF2withHmacSHA512")//Password Based Key Derivation used hash that have 256 bits
                        .generateSecret(new PBEKeySpec(password.toCharArray(), salt, 10000, (keylen + ivlen) * 8)).getEncoded();//to generate key and IV
                Cipher ciph = Cipher.getInstance("AES/CBC/PKCS5Padding");
                ciph.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(keyandIV, 0, keylen, "AES"),
                        new IvParameterSpec(keyandIV, keylen, ivlen));
                outputStream.write("Salted__".getBytes(StandardCharsets.US_ASCII));
                ...
                outputStream.close();
                 is.close();
                output.setText("File is encrypted");       
            }
